...
DB = {
	...
	"data_parametria": {
		"201706": {
			"1": {
				"cdValidacion": 1,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='REM'\nAND CD_ESTADO='AG';",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS REMOTOS EN AG",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
				"stCriticidad": "0",
				"fhCierre": "08/31/2017",
				"stActivo": "1",
				"nbWorkflow": "empty",
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.413Z",
				"fhModificacion": "2017-09-12T19:29:58.413Z",
				"resultado": {
					"txResultado": "64",
					"fhEjecucion": "09/8/2017"
				}
			},
			"2": {
				"cdValidacion": 2,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='REM'\nAND CD_ESTADO='BN';",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS REMOTOS EN BN",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.414Z",
				"fhModificacion": "2017-09-12T19:29:58.414Z",
				"resultado": {
					"txResultado": "190",
					"fhEjecucion": "09/8/2017"
				}
			...
			"3": {
				"cdValidacion": 3,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='REM'\nAND CD_ESTADO='BS';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS REMOTOS EN BS",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"4": {
				"cdValidacion": 4,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='REM'\nAND CD_ESTADO='CA';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS REMOTOS EN CA",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.415Z",
				"fhModificacion": "2017-09-12T19:29:58.415Z",
				"resultado": {
					"txResultado": "60",
					"fhEjecucion": "09/8/2017"
				}
			...
			"5": {
				"cdValidacion": 5,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='REM'\nAND CD_ESTADO='CH';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS REMOTOS EN CH",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"6": {
				"cdValidacion": 6,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='REM'\nAND CD_ESTADO='CO';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS REMOTOS EN CO",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"7": {
				"cdValidacion": 7,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='REM'\nAND CD_ESTADO='CS';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS REMOTOS EN CS",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.416Z",
				"fhModificacion": "2017-09-12T19:29:58.416Z",
				"resultado": {
					"txResultado": "84",
					"fhEjecucion": "09/8/2017"
				}
			...
			"8": {
				"cdValidacion": 8,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='REM'\nAND CD_ESTADO='CU';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS REMOTOS EN CU",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"9": {
				"cdValidacion": 9,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='REM'\nAND CD_ESTADO='DF';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS REMOTOS EN DF",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"10": {
				"cdValidacion": 10,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='REM'\nAND CD_ESTADO='DU';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS REMOTOS EN DU",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.417Z",
				"fhModificacion": "2017-09-12T19:29:58.417Z",
				"resultado": {
					"txResultado": "54",
					"fhEjecucion": "09/8/2017"
				}
			...
			"11": {
				"cdValidacion": 11,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='REM'\nAND CD_ESTADO='EM';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS REMOTOS EN EM",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"12": {
				"cdValidacion": 12,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='REM'\nAND CD_ESTADO='GO';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS REMOTOS EN GO",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.418Z",
				"fhModificacion": "2017-09-12T19:29:58.418Z",
				"resultado": {
					"txResultado": "65",
					"fhEjecucion": "09/8/2017"
				}
			...
			"13": {
				"cdValidacion": 13,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='REM'\nAND CD_ESTADO='GU';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS REMOTOS EN GU",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"14": {
				"cdValidacion": 14,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='REM'\nAND CD_ESTADO='HI';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS REMOTOS EN HI",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"15": {
				"cdValidacion": 15,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='REM'\nAND CD_ESTADO='JA';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS REMOTOS EN JA",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.419Z",
				"fhModificacion": "2017-09-12T19:29:58.419Z",
				"resultado": {
					"txResultado": "222",
					"fhEjecucion": "09/8/2017"
				}
			...
			"16": {
				"cdValidacion": 16,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='REM'\nAND CD_ESTADO='MI';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS REMOTOS EN MI",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"17": {
				"cdValidacion": 17,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='REM'\nAND CD_ESTADO='MO';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS REMOTOS EN MO",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"18": {
				"cdValidacion": 18,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='REM'\nAND CD_ESTADO='NA';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS REMOTOS EN NA",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"19": {
				"cdValidacion": 19,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='REM'\nAND CD_ESTADO='NL';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS REMOTOS EN NL",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.420Z",
				"fhModificacion": "2017-09-12T19:29:58.420Z",
				"resultado": {
					"txResultado": "291",
					"fhEjecucion": "09/8/2017"
				}
			...
			"20": {
				"cdValidacion": 20,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='REM'\nAND CD_ESTADO='OA';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS REMOTOS EN OA",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"21": {
				"cdValidacion": 21,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='REM'\nAND CD_ESTADO='PU';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS REMOTOS EN PU",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"22": {
				"cdValidacion": 22,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='REM'\nAND CD_ESTADO='QR';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS REMOTOS EN QR",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.421Z",
				"fhModificacion": "2017-09-12T19:29:58.421Z",
				"resultado": {
					"txResultado": "167",
					"fhEjecucion": "09/8/2017"
				}
			...
			"23": {
				"cdValidacion": 23,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='REM'\nAND CD_ESTADO='QU';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS REMOTOS EN QU",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"24": {
				"cdValidacion": 24,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='REM'\nAND CD_ESTADO='SI';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS REMOTOS EN SI",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"25": {
				"cdValidacion": 25,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='REM'\nAND CD_ESTADO='SL';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS REMOTOS EN SL",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.422Z",
				"fhModificacion": "2017-09-12T19:29:58.422Z",
				"resultado": {
					"txResultado": "64",
					"fhEjecucion": "09/8/2017"
				}
			...
			"26": {
				"cdValidacion": 26,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='REM'\nAND CD_ESTADO='SO';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS REMOTOS EN SO",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"27": {
				"cdValidacion": 27,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='REM'\nAND CD_ESTADO='TA';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS REMOTOS EN TA",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.423Z",
				"fhModificacion": "2017-09-12T19:29:58.423Z",
				"resultado": {
					"txResultado": "122",
					"fhEjecucion": "09/8/2017"
				}
			...
			"28": {
				"cdValidacion": 28,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='REM'\nAND CD_ESTADO='TL';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS REMOTOS EN TL",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"29": {
				"cdValidacion": 29,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='REM'\nAND CD_ESTADO='TM';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS REMOTOS EN TM",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"30": {
				"cdValidacion": 30,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='REM'\nAND CD_ESTADO='VE';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS REMOTOS EN VE",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.424Z",
				"fhModificacion": "2017-09-12T19:29:58.424Z",
				"resultado": {
					"txResultado": "309",
					"fhEjecucion": "09/8/2017"
				}
			...
			"31": {
				"cdValidacion": 31,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='REM'\nAND CD_ESTADO='YU';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS REMOTOS EN YU",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"32": {
				"cdValidacion": 32,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='REM'\nAND CD_ESTADO='ZA';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS REMOTOS EN ZA",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"33": {
				...
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS POR SUCURSAL EN AG",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.425Z",
				"fhModificacion": "2017-09-12T19:29:58.425Z",
				"resultado": {
					"txResultado": "115",
					"fhEjecucion": "09/8/2017"
				}
			...
			"34": {
				"cdValidacion": 34,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='SUC'\nAND CD_ESTADO='BN';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS POR SUCURSAL EN BN",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"35": {
				"cdValidacion": 35,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='SUC'\nAND CD_ESTADO='BS';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS POR SUCURSAL EN BS",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"36": {
				"cdValidacion": 36,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='SUC'\nAND CD_ESTADO='CA';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS POR SUCURSAL EN CA",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.426Z",
				"fhModificacion": "2017-09-12T19:29:58.426Z",
				"resultado": {
					"txResultado": "90",
					"fhEjecucion": "09/8/2017"
				}
			...
			"37": {
				"cdValidacion": 37,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='SUC'\nAND CD_ESTADO='CH';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS POR SUCURSAL EN CH",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"38": {
				"cdValidacion": 38,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='SUC'\nAND CD_ESTADO='CO';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS POR SUCURSAL EN CO",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"39": {
				"cdValidacion": 39,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='SUC'\nAND CD_ESTADO='CS';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS POR SUCURSAL EN CS",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.427Z",
				"fhModificacion": "2017-09-12T19:29:58.427Z",
				"resultado": {
					"txResultado": "216",
					"fhEjecucion": "09/8/2017"
				}
			...
			"40": {
				"cdValidacion": 40,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='SUC'\nAND CD_ESTADO='CU';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS POR SUCURSAL EN CU",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"41": {
				"cdValidacion": 41,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='SUC'\nAND CD_ESTADO='DF';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS POR SUCURSAL EN DF",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"42": {
				"cdValidacion": 42,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='SUC'\nAND CD_ESTADO='DU';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS POR SUCURSAL EN DU",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.428Z",
				"fhModificacion": "2017-09-12T19:29:58.428Z",
				"resultado": {
					"txResultado": "113",
					"fhEjecucion": "09/8/2017"
				}
			...
			"43": {
				"cdValidacion": 43,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='SUC'\nAND CD_ESTADO='EM';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS POR SUCURSAL EN EM",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"44": {
				"cdValidacion": 44,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='SUC'\nAND CD_ESTADO='GO';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS POR SUCURSAL EN GO",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"45": {
				"cdValidacion": 45,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='SUC'\nAND CD_ESTADO='GU';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS POR SUCURSAL EN GU",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.429Z",
				"fhModificacion": "2017-09-12T19:29:58.429Z",
				"resultado": {
					"txResultado": "465",
					"fhEjecucion": "09/8/2017"
				}
			...
			"46": {
				"cdValidacion": 46,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='SUC'\nAND CD_ESTADO='HI';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS POR SUCURSAL EN HI",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"47": {
				"cdValidacion": 47,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='SUC'\nAND CD_ESTADO='JA';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS POR SUCURSAL EN JA",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"48": {
				"cdValidacion": 48,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='SUC'\nAND CD_ESTADO='MI';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS POR SUCURSAL EN MI",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.430Z",
				"fhModificacion": "2017-09-12T19:29:58.430Z",
				"resultado": {
					"txResultado": "480",
					"fhEjecucion": "09/8/2017"
				}
			...
			"49": {
				"cdValidacion": 49,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='SUC'\nAND CD_ESTADO='MO';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS POR SUCURSAL EN MO",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"50": {
				"cdValidacion": 50,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='SUC'\nAND CD_ESTADO='NA';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS POR SUCURSAL EN NA",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"51": {
				"cdValidacion": 51,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='SUC'\nAND CD_ESTADO='NL';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS POR SUCURSAL EN NL",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.431Z",
				"fhModificacion": "2017-09-12T19:29:58.431Z",
				"resultado": {
					"txResultado": "419",
					"fhEjecucion": "09/8/2017"
				}
			...
			"52": {
				"cdValidacion": 52,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='SUC'\nAND CD_ESTADO='OA';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS POR SUCURSAL EN OA",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"53": {
				"cdValidacion": 53,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='SUC'\nAND CD_ESTADO='PU';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS POR SUCURSAL EN PU",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"54": {
				"cdValidacion": 54,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='SUC'\nAND CD_ESTADO='QR';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS POR SUCURSAL EN QR",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.432Z",
				"fhModificacion": "2017-09-12T19:29:58.432Z",
				"resultado": {
					"txResultado": "122",
					"fhEjecucion": "09/8/2017"
				}
			...
			"55": {
				"cdValidacion": 55,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='SUC'\nAND CD_ESTADO='QU';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS POR SUCURSAL EN QU",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"56": {
				"cdValidacion": 56,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='SUC'\nAND CD_ESTADO='SI';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS POR SUCURSAL EN SI",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"57": {
				"cdValidacion": 57,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='SUC'\nAND CD_ESTADO='SL';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS POR SUCURSAL EN SL",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.433Z",
				"fhModificacion": "2017-09-12T19:29:58.433Z",
				"resultado": {
					"txResultado": "146",
					"fhEjecucion": "09/8/2017"
				}
			...
			"58": {
				"cdValidacion": 58,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='SUC'\nAND CD_ESTADO='SO';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS POR SUCURSAL EN SO",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"59": {
				"cdValidacion": 59,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='SUC'\nAND CD_ESTADO='TA';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS POR SUCURSAL EN TA",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"60": {
				"cdValidacion": 60,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='SUC'\nAND CD_ESTADO='TL';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS POR SUCURSAL EN TL",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.434Z",
				"fhModificacion": "2017-09-12T19:29:58.434Z",
				"resultado": {
					"txResultado": "85",
					"fhEjecucion": "09/8/2017"
				}
			...
			"61": {
				"cdValidacion": 61,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='SUC'\nAND CD_ESTADO='TM';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS POR SUCURSAL EN TM",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"62": {
				"cdValidacion": 62,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='SUC'\nAND CD_ESTADO='VE';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS POR SUCURSAL EN VE",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"63": {
				"cdValidacion": 63,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='SUC'\nAND CD_ESTADO='YU';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS POR SUCURSAL EN YU",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.435Z",
				"fhModificacion": "2017-09-12T19:29:58.435Z",
				"resultado": {
					"txResultado": "112",
					"fhEjecucion": "09/8/2017"
				}
			...
			"64": {
				"cdValidacion": 64,
				"txSqlQuery": "SELECT TO_ATM FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_LOC_CAJERO='SUC'\nAND CD_ESTADO='ZA';\n",
				"txDesQuery": "NÚMERO TOTAL DE CAJEROS POR SUCURSAL EN ZA",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"65": {
				"cdValidacion": 65,
				"txSqlQuery": "SELECT SUM(TO_ATM) FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_ESTADO='AG';",
				"txDesQuery": "TOTAL DE NUMERO DE CAJEROS EN ESTADO DE AG",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"66": {
				"cdValidacion": 66,
				"txSqlQuery": "SELECT SUM(TO_ATM) FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_ESTADO='BN';",
				"txDesQuery": "TOTAL DE NUMERO DE CAJEROS EN ESTADO DE BN",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.436Z",
				"fhModificacion": "2017-09-12T19:29:58.436Z",
				"resultado": {
					"txResultado": "516",
					"fhEjecucion": "09/8/2017"
				}
			...
			"67": {
				"cdValidacion": 67,
				"txSqlQuery": "SELECT SUM(TO_ATM) FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_ESTADO='BS';",
				"txDesQuery": "TOTAL DE NUMERO DE CAJEROS EN ESTADO DE BS",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"68": {
				"cdValidacion": 68,
				"txSqlQuery": "SELECT SUM(TO_ATM) FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_ESTADO='CA';",
				"txDesQuery": "TOTAL DE NUMERO DE CAJEROS EN ESTADO DE CA",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.437Z",
				"fhModificacion": "2017-09-12T19:29:58.437Z",
				"resultado": {
					"txResultado": "150",
					"fhEjecucion": "09/8/2017"
				}
			...
			"69": {
				"cdValidacion": 69,
				"txSqlQuery": "SELECT SUM(TO_ATM) FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_ESTADO='CH';",
				"txDesQuery": "TOTAL DE NUMERO DE CAJEROS EN ESTADO DE CH",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"70": {
				"cdValidacion": 70,
				"txSqlQuery": "SELECT SUM(TO_ATM) FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_ESTADO='CO';",
				"txDesQuery": "TOTAL DE NUMERO DE CAJEROS EN ESTADO DE CO",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"71": {
				"cdValidacion": 71,
				"txSqlQuery": "SELECT SUM(TO_ATM) FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_ESTADO='CS';",
				"txDesQuery": "TOTAL DE NUMERO DE CAJEROS EN ESTADO DE CS",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.438Z",
				"fhModificacion": "2017-09-12T19:29:58.438Z",
				"resultado": {
					"txResultado": "300",
					"fhEjecucion": "09/8/2017"
				}
			...
			"72": {
				"cdValidacion": 72,
				"txSqlQuery": "SELECT SUM(TO_ATM) FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_ESTADO='CU';",
				"txDesQuery": "TOTAL DE NUMERO DE CAJEROS EN ESTADO DE CU",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"73": {
				"cdValidacion": 73,
				"txSqlQuery": "SELECT SUM(TO_ATM) FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_ESTADO='DF';",
				"txDesQuery": "TOTAL DE NUMERO DE CAJEROS EN ESTADO DE DF",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"74": {
				"cdValidacion": 74,
				"txSqlQuery": "SELECT SUM(TO_ATM) FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_ESTADO='DU';",
				"txDesQuery": "TOTAL DE NUMERO DE CAJEROS EN ESTADO DE DU",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.439Z",
				"fhModificacion": "2017-09-12T19:29:58.439Z",
				"resultado": {
					"txResultado": "167",
					"fhEjecucion": "09/8/2017"
				}
			...
			"75": {
				"cdValidacion": 75,
				"txSqlQuery": "SELECT SUM(TO_ATM) FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_ESTADO='EM';",
				"txDesQuery": "TOTAL DE NUMERO DE CAJEROS EN ESTADO DE EM",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"76": {
				"cdValidacion": 76,
				"txSqlQuery": "SELECT SUM(TO_ATM) FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_ESTADO='GO';",
				"txDesQuery": "TOTAL DE NUMERO DE CAJEROS EN ESTADO DE GO",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"77": {
				"cdValidacion": 77,
				"txSqlQuery": "SELECT SUM(TO_ATM) FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_ESTADO='GU';",
				"txDesQuery": "TOTAL DE NUMERO DE CAJEROS EN ESTADO DE GU",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.440Z",
				"fhModificacion": "2017-09-12T19:29:58.440Z",
				"resultado": {
					"txResultado": "599",
					"fhEjecucion": "09/8/2017"
				}
			...
			"78": {
				"cdValidacion": 78,
				"txSqlQuery": "SELECT SUM(TO_ATM) FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_ESTADO='HI';",
				"txDesQuery": "TOTAL DE NUMERO DE CAJEROS EN ESTADO DE HI",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"79": {
				"cdValidacion": 79,
				"txSqlQuery": "SELECT SUM(TO_ATM) FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_ESTADO='JA';",
				"txDesQuery": "TOTAL DE NUMERO DE CAJEROS EN ESTADO DE JA",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"80": {
				"cdValidacion": 80,
				"txSqlQuery": "SELECT SUM(TO_ATM) FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_ESTADO='MI';",
				"txDesQuery": "TOTAL DE NUMERO DE CAJEROS EN ESTADO DE MI",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.441Z",
				"fhModificacion": "2017-09-12T19:29:58.441Z",
				"resultado": {
					"txResultado": "560",
					"fhEjecucion": "09/8/2017"
				}
			...
			"81": {
				"cdValidacion": 81,
				"txSqlQuery": "SELECT SUM(TO_ATM) FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_ESTADO='MO';",
				"txDesQuery": "TOTAL DE NUMERO DE CAJEROS EN ESTADO DE MO",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"82": {
				"cdValidacion": 82,
				"txSqlQuery": "SELECT SUM(TO_ATM) FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_ESTADO='NA';",
				"txDesQuery": "TOTAL DE NUMERO DE CAJEROS EN ESTADO DE NA",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"83": {
				"cdValidacion": 83,
				"txSqlQuery": "SELECT SUM(TO_ATM) FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_ESTADO='NL';",
				"txDesQuery": "TOTAL DE NUMERO DE CAJEROS EN ESTADO DE NL",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.442Z",
				"fhModificacion": "2017-09-12T19:29:58.442Z",
				"resultado": {
					"txResultado": "710",
					"fhEjecucion": "09/8/2017"
				}
			...
			"84": {
				"cdValidacion": 84,
				"txSqlQuery": "SELECT SUM(TO_ATM) FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_ESTADO='OA';",
				"txDesQuery": "TOTAL DE NUMERO DE CAJEROS EN ESTADO DE OA",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"85": {
				"cdValidacion": 85,
				"txSqlQuery": "SELECT SUM(TO_ATM) FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_ESTADO='PU';",
				"txDesQuery": "TOTAL DE NUMERO DE CAJEROS EN ESTADO DE PU",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"86": {
				"cdValidacion": 86,
				"txSqlQuery": "SELECT SUM(TO_ATM) FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_ESTADO='QR';",
				"txDesQuery": "TOTAL DE NUMERO DE CAJEROS EN ESTADO DE QR",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.443Z",
				"fhModificacion": "2017-09-12T19:29:58.443Z",
				"resultado": {
					"txResultado": "289",
					"fhEjecucion": "09/8/2017"
				}
			...
			"87": {
				"cdValidacion": 87,
				"txSqlQuery": "SELECT SUM(TO_ATM) FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_ESTADO='QU';",
				"txDesQuery": "TOTAL DE NUMERO DE CAJEROS EN ESTADO DE QU",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"88": {
				"cdValidacion": 88,
				"txSqlQuery": "SELECT SUM(TO_ATM) FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_ESTADO='SI';",
				"txDesQuery": "TOTAL DE NUMERO DE CAJEROS EN ESTADO DE SI",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"89": {
				"cdValidacion": 89,
				"txSqlQuery": "SELECT SUM(TO_ATM) FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_ESTADO='SL';",
				"txDesQuery": "TOTAL DE NUMERO DE CAJEROS EN ESTADO DE SL",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"90": {
				"cdValidacion": 90,
				"txSqlQuery": "SELECT SUM(TO_ATM) FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_ESTADO='SO';",
				"txDesQuery": "TOTAL DE NUMERO DE CAJEROS EN ESTADO DE SO",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.444Z",
				"fhModificacion": "2017-09-12T19:29:58.444Z",
				"resultado": {
					"txResultado": "472",
					"fhEjecucion": "09/8/2017"
				}
			...
			"91": {
				"cdValidacion": 91,
				"txSqlQuery": "SELECT SUM(TO_ATM) FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_ESTADO='TA';",
				"txDesQuery": "TOTAL DE NUMERO DE CAJEROS EN ESTADO DE TA",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"92": {
				"cdValidacion": 92,
				"txSqlQuery": "SELECT SUM(TO_ATM) FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_ESTADO='TL';",
				"txDesQuery": "TOTAL DE NUMERO DE CAJEROS EN ESTADO DE TL",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.445Z",
				"fhModificacion": "2017-09-12T19:29:58.445Z",
				"resultado": {
					"txResultado": "115",
					"fhEjecucion": "09/8/2017"
				}
			...
			"93": {
				"cdValidacion": 93,
				"txSqlQuery": "SELECT SUM(TO_ATM) FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_ESTADO='TM';",
				"txDesQuery": "TOTAL DE NUMERO DE CAJEROS EN ESTADO DE TM",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"94": {
				"cdValidacion": 94,
				"txSqlQuery": "SELECT SUM(TO_ATM) FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_ESTADO='VE';",
				"txDesQuery": "TOTAL DE NUMERO DE CAJEROS EN ESTADO DE VE",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"95": {
				"cdValidacion": 95,
				"txSqlQuery": "SELECT SUM(TO_ATM) FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_ESTADO='YU';",
				"txDesQuery": "TOTAL DE NUMERO DE CAJEROS EN ESTADO DE YU",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.446Z",
				"fhModificacion": "2017-09-12T19:29:58.446Z",
				"resultado": {
					"txResultado": "184",
					"fhEjecucion": "09/8/2017"
				}
			...
			"96": {
				"cdValidacion": 96,
				"txSqlQuery": "SELECT SUM(TO_ATM) FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706'\nAND CD_ESTADO='ZA';",
				"txDesQuery": "TOTAL DE NUMERO DE CAJEROS EN ESTADO DE ZA",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"97": {
				"cdValidacion": 97,
				"txSqlQuery": "SELECT SUM(TO_ATM) FROM ZREG_FACT.TDRR852_ATM_VERTICAL\nWHERE CD_PERIODO='201706';",
				"txDesQuery": "NUMERO TOTAL DE ATMS A NIVEL REPUBLICA MEXICANA",
				"nbTabla": "TDRR852_ATM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN DE CAJEROS",
			...
			"98": {
				"cdValidacion": 98,
				"txSqlQuery": "SELECT SUM(TO_TPV) FROM ZREG_FACT.TDRR851_TPV_VERTICAL\nWHERE CD_PERIODO='201706';",
				"txDesQuery": "NUMERO TOTAL DE TPVS A NIVEL REPUBLICA MEXICANA",
				"nbTabla": "TDRR851_TPV_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN TPVS",
				"stCriticidad": "0",
				"fhCierre": "08/31/2017",
				"stActivo": "1",
				"nbWorkflow": "empty",
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.447Z",
				"fhModificacion": "2017-09-12T19:29:58.447Z",
				"resultado": {
					"txResultado": "251527",
					"fhEjecucion": "09/8/2017"
				}
			...
			"99": {
				"cdValidacion": 99,
				"txSqlQuery": "SELECT TO_TPV FROM ZREG_FACT.TDRR851_TPV_VERTICAL\nWHERE CD_PERIODO= '201706'\nAND CD_ESTADO= 'AG';",
				"txDesQuery": "NUMERO TOTAL DE TPVS EN EL ESTADO DE AG EN EL PERIODO 201706",
				"nbTabla": "TDRR851_TPV_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN TPVS",
			...
			"100": {
				"cdValidacion": 100,
				"txSqlQuery": "SELECT TO_TPV FROM ZREG_FACT.TDRR851_TPV_VERTICAL\nWHERE CD_PERIODO= '201706'\nAND CD_ESTADO= 'BN';",
				"txDesQuery": "NUMERO TOTAL DE TPVS EN EL ESTADO DE BN EN EL PERIODO 201706",
				"nbTabla": "TDRR851_TPV_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN TPVS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.448Z",
				"fhModificacion": "2017-09-12T19:29:58.471Z",
				"resultado": {
					"txResultado": "9597",
					"fhEjecucion": "09/8/2017"
				}
			...
			"101": {
				"cdValidacion": 101,
				"txSqlQuery": "SELECT TO_TPV FROM ZREG_FACT.TDRR851_TPV_VERTICAL\nWHERE CD_PERIODO= '201706'\nAND CD_ESTADO= 'BS';",
				"txDesQuery": "NUMERO TOTAL DE TPVS EN EL ESTADO DE BS EN EL PERIODO 201706",
				"nbTabla": "TDRR851_TPV_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN TPVS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.472Z",
				"fhModificacion": "2017-09-12T19:29:58.472Z",
				"resultado": {
					"txResultado": "5251",
					"fhEjecucion": "09/8/2017"
				}
			...
			"102": {
				"cdValidacion": 102,
				"txSqlQuery": "SELECT TO_TPV FROM ZREG_FACT.TDRR851_TPV_VERTICAL\nWHERE CD_PERIODO= '201706'\nAND CD_ESTADO= 'CA';",
				"txDesQuery": "NUMERO TOTAL DE TPVS EN EL ESTADO DE CA EN EL PERIODO 201706",
				"nbTabla": "TDRR851_TPV_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN TPVS",
			...
			"103": {
				"cdValidacion": 103,
				"txSqlQuery": "SELECT TO_TPV FROM ZREG_FACT.TDRR851_TPV_VERTICAL\nWHERE CD_PERIODO= '201706'\nAND CD_ESTADO= 'CH';",
				"txDesQuery": "NUMERO TOTAL DE TPVS EN EL ESTADO DE CH EN EL PERIODO 201706",
				"nbTabla": "TDRR851_TPV_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN TPVS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.473Z",
				"fhModificacion": "2017-09-12T19:29:58.473Z",
				"resultado": {
					"txResultado": "7721",
					"fhEjecucion": "09/8/2017"
				}
			...
			"104": {
				"cdValidacion": 104,
				"txSqlQuery": "SELECT TO_TPV FROM ZREG_FACT.TDRR851_TPV_VERTICAL\nWHERE CD_PERIODO= '201706'\nAND CD_ESTADO= 'CO';",
				"txDesQuery": "NUMERO TOTAL DE TPVS EN EL ESTADO DE CO EN EL PERIODO 201706",
				"nbTabla": "TDRR851_TPV_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN TPVS",
			...
			"105": {
				"cdValidacion": 105,
				"txSqlQuery": "SELECT TO_TPV FROM ZREG_FACT.TDRR851_TPV_VERTICAL\nWHERE CD_PERIODO= '201706'\nAND CD_ESTADO= 'CS';",
				"txDesQuery": "NUMERO TOTAL DE TPVS EN EL ESTADO DE CS EN EL PERIODO 201706",
				"nbTabla": "TDRR851_TPV_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN TPVS",
			...
			"106": {
				"cdValidacion": 106,
				"txSqlQuery": "SELECT TO_TPV FROM ZREG_FACT.TDRR851_TPV_VERTICAL\nWHERE CD_PERIODO= '201706'\nAND CD_ESTADO= 'CU';",
				"txDesQuery": "NUMERO TOTAL DE TPVS EN EL ESTADO DE CU EN EL PERIODO 201706",
				"nbTabla": "TDRR851_TPV_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN TPVS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.474Z",
				"fhModificacion": "2017-09-12T19:29:58.474Z",
				"resultado": {
					"txResultado": "7156",
					"fhEjecucion": "09/8/2017"
				}
			...
			"107": {
				"cdValidacion": 107,
				"txSqlQuery": "SELECT TO_TPV FROM ZREG_FACT.TDRR851_TPV_VERTICAL\nWHERE CD_PERIODO= '201706'\nAND CD_ESTADO= 'DF';",
				"txDesQuery": "NUMERO TOTAL DE TPVS EN EL ESTADO DE DF EN EL PERIODO 201706",
				"nbTabla": "TDRR851_TPV_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN TPVS",
			...
			"108": {
				"cdValidacion": 108,
				"txSqlQuery": "SELECT TO_TPV FROM ZREG_FACT.TDRR851_TPV_VERTICAL\nWHERE CD_PERIODO= '201706'\nAND CD_ESTADO= 'DU';",
				"txDesQuery": "NUMERO TOTAL DE TPVS EN EL ESTADO DE DU EN EL PERIODO 201706",
				"nbTabla": "TDRR851_TPV_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN TPVS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.475Z",
				"fhModificacion": "2017-09-12T19:29:58.475Z",
				"resultado": {
					"txResultado": "2691",
					"fhEjecucion": "09/8/2017"
				}
			...
			"109": {
				"cdValidacion": 109,
				"txSqlQuery": "SELECT TO_TPV FROM ZREG_FACT.TDRR851_TPV_VERTICAL\nWHERE CD_PERIODO= '201706'\nAND CD_ESTADO= 'EM';",
				"txDesQuery": "NUMERO TOTAL DE TPVS EN EL ESTADO DE EM EN EL PERIODO 201706",
				"nbTabla": "TDRR851_TPV_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN TPVS",
			...
			"110": {
				"cdValidacion": 110,
				"txSqlQuery": "SELECT TO_TPV FROM ZREG_FACT.TDRR851_TPV_VERTICAL\nWHERE CD_PERIODO= '201706'\nAND CD_ESTADO= 'GO';",
				"txDesQuery": "NUMERO TOTAL DE TPVS EN EL ESTADO DE GO EN EL PERIODO 201706",
				"nbTabla": "TDRR851_TPV_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN TPVS",
			...
			"111": {
				"cdValidacion": 111,
				"txSqlQuery": "SELECT TO_TPV FROM ZREG_FACT.TDRR851_TPV_VERTICAL\nWHERE CD_PERIODO= '201706'\nAND CD_ESTADO= 'GU';",
				"txDesQuery": "NUMERO TOTAL DE TPVS EN EL ESTADO DE GU EN EL PERIODO 201706",
				"nbTabla": "TDRR851_TPV_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN TPVS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.476Z",
				"fhModificacion": "2017-09-12T19:29:58.476Z",
				"resultado": {
					"txResultado": "9018",
					"fhEjecucion": "09/8/2017"
				}
			...
			"112": {
				"cdValidacion": 112,
				"txSqlQuery": "SELECT TO_TPV FROM ZREG_FACT.TDRR851_TPV_VERTICAL\nWHERE CD_PERIODO= '201706'\nAND CD_ESTADO= 'HI';",
				"txDesQuery": "NUMERO TOTAL DE TPVS EN EL ESTADO DE HI EN EL PERIODO 201706",
				"nbTabla": "TDRR851_TPV_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN TPVS",
			...
			"113": {
				"cdValidacion": 113,
				"txSqlQuery": "SELECT TO_TPV FROM ZREG_FACT.TDRR851_TPV_VERTICAL\nWHERE CD_PERIODO= '201706'\nAND CD_ESTADO= 'JA';",
				"txDesQuery": "NUMERO TOTAL DE TPVS EN EL ESTADO DE JA EN EL PERIODO 201706",
				"nbTabla": "TDRR851_TPV_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN TPVS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.477Z",
				"fhModificacion": "2017-09-12T19:29:58.477Z",
				"resultado": {
					"txResultado": "21259",
					"fhEjecucion": "09/8/2017"
				}
			...
			"114": {
				"cdValidacion": 114,
				"txSqlQuery": "SELECT TO_TPV FROM ZREG_FACT.TDRR851_TPV_VERTICAL\nWHERE CD_PERIODO= '201706'\nAND CD_ESTADO= 'MI';",
				"txDesQuery": "NUMERO TOTAL DE TPVS EN EL ESTADO DE MI EN EL PERIODO 201706",
				"nbTabla": "TDRR851_TPV_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN TPVS",
			...
			"115": {
				"cdValidacion": 115,
				"txSqlQuery": "SELECT TO_TPV FROM ZREG_FACT.TDRR851_TPV_VERTICAL\nWHERE CD_PERIODO= '201706'\nAND CD_ESTADO= 'MO';",
				"txDesQuery": "NUMERO TOTAL DE TPVS EN EL ESTADO DE MO EN EL PERIODO 201706",
				"nbTabla": "TDRR851_TPV_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN TPVS",
			...
			"116": {
				"cdValidacion": 116,
				"txSqlQuery": "SELECT TO_TPV FROM ZREG_FACT.TDRR851_TPV_VERTICAL\nWHERE CD_PERIODO= '201706'\nAND CD_ESTADO= 'NA';",
				"txDesQuery": "NUMERO TOTAL DE TPVS EN EL ESTADO DE NA EN EL PERIODO 201706",
				"nbTabla": "TDRR851_TPV_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN TPVS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.478Z",
				"fhModificacion": "2017-09-12T19:29:58.478Z",
				"resultado": {
					"txResultado": "2573",
					"fhEjecucion": "09/8/2017"
				}
			...
			"117": {
				"cdValidacion": 117,
				"txSqlQuery": "SELECT TO_TPV FROM ZREG_FACT.TDRR851_TPV_VERTICAL\nWHERE CD_PERIODO= '201706'\nAND CD_ESTADO= 'NL';",
				"txDesQuery": "NUMERO TOTAL DE TPVS EN EL ESTADO DE NL EN EL PERIODO 201706",
				"nbTabla": "TDRR851_TPV_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN TPVS",
			...
			"118": {
				"cdValidacion": 118,
				"txSqlQuery": "SELECT TO_TPV FROM ZREG_FACT.TDRR851_TPV_VERTICAL\nWHERE CD_PERIODO= '201706'\nAND CD_ESTADO= 'OA';",
				"txDesQuery": "NUMERO TOTAL DE TPVS EN EL ESTADO DE OA EN EL PERIODO 201706",
				"nbTabla": "TDRR851_TPV_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN TPVS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.479Z",
				"fhModificacion": "2017-09-12T19:29:58.479Z",
				"resultado": {
					"txResultado": "3259",
					"fhEjecucion": "09/8/2017"
				}
			...
			"119": {
				"cdValidacion": 119,
				"txSqlQuery": "SELECT TO_TPV FROM ZREG_FACT.TDRR851_TPV_VERTICAL\nWHERE CD_PERIODO= '201706'\nAND CD_ESTADO= 'PU';",
				"txDesQuery": "NUMERO TOTAL DE TPVS EN EL ESTADO DE PU EN EL PERIODO 201706",
				"nbTabla": "TDRR851_TPV_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN TPVS",
			...
			"120": {
				"cdValidacion": 120,
				"txSqlQuery": "SELECT TO_TPV FROM ZREG_FACT.TDRR851_TPV_VERTICAL\nWHERE CD_PERIODO= '201706'\nAND CD_ESTADO= 'QR';",
				"txDesQuery": "NUMERO TOTAL DE TPVS EN EL ESTADO DE QR EN EL PERIODO 201706",
				"nbTabla": "TDRR851_TPV_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN TPVS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.480Z",
				"fhModificacion": "2017-09-12T19:29:58.480Z",
				"resultado": {
					"txResultado": "11128",
					"fhEjecucion": "09/8/2017"
				}
			...
			"121": {
				"cdValidacion": 121,
				"txSqlQuery": "SELECT TO_TPV FROM ZREG_FACT.TDRR851_TPV_VERTICAL\nWHERE CD_PERIODO= '201706'\nAND CD_ESTADO= 'QU';",
				"txDesQuery": "NUMERO TOTAL DE TPVS EN EL ESTADO DE QU EN EL PERIODO 201706",
				"nbTabla": "TDRR851_TPV_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN TPVS",
			...
			"122": {
				"cdValidacion": 122,
				"txSqlQuery": "SELECT TO_TPV FROM ZREG_FACT.TDRR851_TPV_VERTICAL\nWHERE CD_PERIODO= '201706'\nAND CD_ESTADO= 'SI';",
				"txDesQuery": "NUMERO TOTAL DE TPVS EN EL ESTADO DE SI EN EL PERIODO 201706",
				"nbTabla": "TDRR851_TPV_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN TPVS",
			...
			"123": {
				"cdValidacion": 123,
				"txSqlQuery": "SELECT TO_TPV FROM ZREG_FACT.TDRR851_TPV_VERTICAL\nWHERE CD_PERIODO= '201706'\nAND CD_ESTADO= 'SL';",
				"txDesQuery": "NUMERO TOTAL DE TPVS EN EL ESTADO DE SL EN EL PERIODO 201706",
				"nbTabla": "TDRR851_TPV_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN TPVS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.481Z",
				"fhModificacion": "2017-09-12T19:29:58.481Z",
				"resultado": {
					"txResultado": "4179",
					"fhEjecucion": "09/8/2017"
				}
			...
			"124": {
				"cdValidacion": 124,
				"txSqlQuery": "SELECT TO_TPV FROM ZREG_FACT.TDRR851_TPV_VERTICAL\nWHERE CD_PERIODO= '201706'\nAND CD_ESTADO= 'SO';",
				"txDesQuery": "NUMERO TOTAL DE TPVS EN EL ESTADO DE SO EN EL PERIODO 201706",
				"nbTabla": "TDRR851_TPV_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN TPVS",
			...
			"125": {
				"cdValidacion": 125,
				"txSqlQuery": "SELECT TO_TPV FROM ZREG_FACT.TDRR851_TPV_VERTICAL\nWHERE CD_PERIODO= '201706'\nAND CD_ESTADO= 'TA';",
				"txDesQuery": "NUMERO TOTAL DE TPVS EN EL ESTADO DE TA EN EL PERIODO 201706",
				"nbTabla": "TDRR851_TPV_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN TPVS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.482Z",
				"fhModificacion": "2017-09-12T19:29:58.482Z",
				"resultado": {
					"txResultado": "4426",
					"fhEjecucion": "09/8/2017"
				}
			...
			"126": {
				"cdValidacion": 126,
				"txSqlQuery": "SELECT TO_TPV FROM ZREG_FACT.TDRR851_TPV_VERTICAL\nWHERE CD_PERIODO= '201706'\nAND CD_ESTADO= 'TL';",
				"txDesQuery": "NUMERO TOTAL DE TPVS EN EL ESTADO DE TL EN EL PERIODO 201706",
				"nbTabla": "TDRR851_TPV_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN TPVS",
			...
			"127": {
				"cdValidacion": 127,
				"txSqlQuery": "SELECT TO_TPV FROM ZREG_FACT.TDRR851_TPV_VERTICAL\nWHERE CD_PERIODO= '201706'\nAND CD_ESTADO= 'TM';",
				"txDesQuery": "NUMERO TOTAL DE TPVS EN EL ESTADO DE TM EN EL PERIODO 201706",
				"nbTabla": "TDRR851_TPV_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN TPVS",
			...
			"128": {
				"cdValidacion": 128,
				"txSqlQuery": "SELECT TO_TPV FROM ZREG_FACT.TDRR851_TPV_VERTICAL\nWHERE CD_PERIODO= '201706'\nAND CD_ESTADO= 'VE';",
				"txDesQuery": "NUMERO TOTAL DE TPVS EN EL ESTADO DE VE EN EL PERIODO 201706",
				"nbTabla": "TDRR851_TPV_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN TPVS",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.483Z",
				"fhModificacion": "2017-09-12T19:29:58.483Z",
				"resultado": {
					"txResultado": "10695",
					"fhEjecucion": "09/8/2017"
				}
			...
			"129": {
				"cdValidacion": 129,
				"txSqlQuery": "SELECT TO_TPV FROM ZREG_FACT.TDRR851_TPV_VERTICAL\nWHERE CD_PERIODO= '201706'\nAND CD_ESTADO= 'YU';",
				"txDesQuery": "NUMERO TOTAL DE TPVS EN EL ESTADO DE YU EN EL PERIODO 201706",
				"nbTabla": "TDRR851_TPV_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN TPVS",
			...
			"130": {
				"cdValidacion": 130,
				"txSqlQuery": "SELECT TO_TPV FROM ZREG_FACT.TDRR851_TPV_VERTICAL\nWHERE CD_PERIODO= '201706'\nAND CD_ESTADO= 'ZA';",
				"txDesQuery": "NUMERO TOTAL DE TPVS EN EL ESTADO DE ZA EN EL PERIODO 201706",
				"nbTabla": "TDRR851_TPV_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DISTRIBUCIÓN TPVS",
			...
			"131": {
				"cdValidacion": 131,
				"txSqlQuery": "select sum(im_domiciliacion) from zreg_fact.TDRR853_DOM_VERTICAL\nwhere cd_periodo='201706';",
				"txDesQuery": "suma de importe con filtro: periodo \"201706\"",
				"nbTabla": "TDRR853_DOM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DOMICILIACIONES",
				"stCriticidad": "0",
				"fhCierre": "08/31/2017",
				"stActivo": "1",
				"nbWorkflow": "empty",
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.484Z",
				"fhModificacion": "2017-09-12T19:29:58.484Z",
				"resultado": {
					"txResultado": "539652893.4",
					"fhEjecucion": "09/8/2017"
				}
			},
			"132": {
				"cdValidacion": 132,
				"txSqlQuery": "select sum(im_domiciliacion) from zreg_fact.TDRR853_DOM_VERTICAL\nwhere cd_nivel_riesgo='1';",
				"txDesQuery": "suma de importe con nivel de riesgo 1",
				"nbTabla": "TDRR853_DOM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DOMICILIACIONES",
			...
			"133": {
				"cdValidacion": 133,
				"txSqlQuery": "select sum(im_domiciliacion) from zreg_fact.TDRR853_DOM_VERTICAL\nwhere cd_nivel_riesgo='2';",
				"txDesQuery": "suma de importe con nivel de riesgo 2",
				"nbTabla": "TDRR853_DOM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DOMICILIACIONES",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.485Z",
				"fhModificacion": "2017-09-12T19:29:58.485Z",
				"resultado": {
					"txResultado": "22396.52",
					"fhEjecucion": "09/8/2017"
				}
			},
			"134": {
				"cdValidacion": 134,
				"txSqlQuery": "select sum(im_domiciliacion) from zreg_fact.TDRR853_DOM_VERTICAL\nwhere cd_nivel_riesgo='3';",
				"txDesQuery": "suma de importe con nivel de riesgo 3",
				"nbTabla": "TDRR853_DOM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DOMICILIACIONES",
			...
			"135": {
				"cdValidacion": 135,
				"txSqlQuery": "select sum(im_domiciliacion) from zreg_fact.TDRR853_DOM_VERTICAL\nwhere cd_nivel_riesgo='4';",
				"txDesQuery": "suma de importe con nivel de riesgo 4",
				"nbTabla": "TDRR853_DOM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DOMICILIACIONES",
				...
				"fhModificacion": "2017-09-12T19:29:58.485Z",
				"resultado": {
					"txResultado": "4476384.46",
					"fhEjecucion": "09/8/2017"
				}
			},
			"136": {
				"cdValidacion": 136,
				"txSqlQuery": "select sum(ct_domiciliacion) from zreg_fact.TDRR853_DOM_VERTICAL\nwhere cd_nivel_riesgo='1';",
				"txDesQuery": "Conteo de domiciliación con nivel de riesgo 1",
				"nbTabla": "TDRR853_DOM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DOMICILIACIONES",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.486Z",
				"fhModificacion": "2017-09-12T19:29:58.486Z",
				"resultado": {
					"txResultado": "0",
					"fhEjecucion": "09/8/2017"
				}
			...
			"137": {
				"cdValidacion": 137,
				"txSqlQuery": "select sum(ct_domiciliacion) from zreg_fact.TDRR853_DOM_VERTICAL\nwhere cd_nivel_riesgo='2';",
				"txDesQuery": "Conteo de domiciliación con nivel de riesgo 2",
				"nbTabla": "TDRR853_DOM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DOMICILIACIONES",
			...
			"138": {
				"cdValidacion": 138,
				"txSqlQuery": "select sum(ct_domiciliacion) from zreg_fact.TDRR853_DOM_VERTICAL\nwhere cd_nivel_riesgo='3';",
				"txDesQuery": "Conteo de domiciliación con nivel de riesgo 3",
				"nbTabla": "TDRR853_DOM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DOMICILIACIONES",
			...
			"139": {
				"cdValidacion": 139,
				"txSqlQuery": "select sum(ct_domiciliacion) from zreg_fact.TDRR853_DOM_VERTICAL\nwhere cd_nivel_riesgo='4';",
				"txDesQuery": "Conteo de domiciliación con nivel de riesgo 4",
				"nbTabla": "TDRR853_DOM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DOMICILIACIONES",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.487Z",
				"fhModificacion": "2017-09-12T19:29:58.487Z",
				"resultado": {
					"txResultado": "7722",
					"fhEjecucion": "09/8/2017"
				}
			...
			"140": {
				"cdValidacion": 140,
				"txSqlQuery": "select sum(im_domiciliacion) from zreg_fact.TDRR853_DOM_VERTICAL\nwhere cd_nivel_riesgo='@';",
				"txDesQuery": "suma de importe con nivel de riesgo @",
				"nbTabla": "TDRR853_DOM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DOMICILIACIONES",
			...
			"141": {
				"cdValidacion": 141,
				"txSqlQuery": "select sum(ct_domiciliacion) from zreg_fact.TDRR853_DOM_VERTICAL\nwhere cd_nivel_riesgo='@';",
				"txDesQuery": "Conteo de domiciliación con nivel de riesgo @",
				"nbTabla": "TDRR853_DOM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DOMICILIACIONES",
			...
			"142": {
				"cdValidacion": 142,
				"txSqlQuery": "select sum(im_domiciliacion) from zreg_fact.TDRR853_DOM_VERTICAL\nwhere cd_personalidad='M';",
				"txDesQuery": "suma de importe con filtro: personalidad \"M\"",
				"nbTabla": "TDRR853_DOM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DOMICILIACIONES",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.488Z",
				"fhModificacion": "2017-09-12T19:29:58.488Z",
				"resultado": {
					"txResultado": "12603",
					"fhEjecucion": "09/8/2017"
				}
			...
			"143": {
				"cdValidacion": 143,
				"txSqlQuery": "select sum(im_domiciliacion) from zreg_fact.TDRR853_DOM_VERTICAL\nwhere cd_personalidad='F';",
				"txDesQuery": "suma de importe con filtro: personalidad \"F\"",
				"nbTabla": "TDRR853_DOM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DOMICILIACIONES",
			...
			"144": {
				"cdValidacion": 144,
				"txSqlQuery": "select sum(im_domiciliacion) from zreg_fact.TDRR853_DOM_VERTICAL\nwhere cd_tipo_operacion='I';",
				"txDesQuery": "suma de importe con filtro: tipo_operacion \"I\"",
				"nbTabla": "TDRR853_DOM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DOMICILIACIONES",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.489Z",
				"fhModificacion": "2017-09-12T19:29:58.489Z",
				"resultado": {
					"txResultado": "539652893.4",
					"fhEjecucion": "09/8/2017"
				}
			...
			"145": {
				"cdValidacion": 145,
				"txSqlQuery": "select sum(ct_domiciliacion) from zreg_fact.TDRR853_DOM_VERTICAL\nwhere cd_periodo='201706';",
				"txDesQuery": "conteo de domiciliacion con filtro: periodo \"201706\"",
				"nbTabla": "TDRR853_DOM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DOMICILIACIONES",
			...
			"146": {
				"cdValidacion": 146,
				"txSqlQuery": "select sum(ct_domiciliacion) from zreg_fact.TDRR853_DOM_VERTICAL\nwhere cd_personalidad='M';",
				"txDesQuery": "conteo de domiciliacion: personalidad \"M\"",
				"nbTabla": "TDRR853_DOM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DOMICILIACIONES",
			...
			"147": {
				"cdValidacion": 147,
				"txSqlQuery": "select sum(ct_domiciliacion) from zreg_fact.TDRR853_DOM_VERTICAL\nwhere cd_personalidad='F';",
				"txDesQuery": "conteo de domiciliacion: personalidad \"F\"",
				"nbTabla": "TDRR853_DOM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DOMICILIACIONES",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.490Z",
				"fhModificacion": "2017-09-12T19:29:58.490Z",
				"resultado": {
					"txResultado": "37",
					"fhEjecucion": "09/8/2017"
				}
			...
			"148": {
				"cdValidacion": 148,
				"txSqlQuery": "select sum(ct_domiciliacion) from zreg_fact.TDRR853_DOM_VERTICAL\nwhere cd_tipo_operacion='I';",
				"txDesQuery": "conteo de domiciliacion: tipo_operacion \"I\"",
				"nbTabla": "TDRR853_DOM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DOMICILIACIONES",
			...
			"149": {
				"cdValidacion": 149,
				"txSqlQuery": "select sum(im_domiciliacion) from zreg_fact.TDRR853_DOM_VERTICAL\nwhere cd_personalidad='M'\nand cd_periodo='201706';",
				"txDesQuery": "suma de importe con filtros: periodo \"201706\", personalidad \"M\"",
				"nbTabla": "TDRR853_DOM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DOMICILIACIONES",
			...
			"150": {
				"cdValidacion": 150,
				"txSqlQuery": "select sum(im_domiciliacion) from zreg_fact.TDRR853_DOM_VERTICAL\nwhere cd_personalidad='F'\nand cd_periodo='201706';",
				"txDesQuery": "suma de importe con filtros: periodo \"201706\", personalidad \"F\"",
				"nbTabla": "TDRR853_DOM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DOMICILIACIONES",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.491Z",
				"fhModificacion": "2017-09-12T19:29:58.491Z",
				"resultado": {
					"txResultado": "15268",
					"fhEjecucion": "09/8/2017"
				}
			...
			"151": {
				"cdValidacion": 151,
				"txSqlQuery": "select sum(im_domiciliacion) from zreg_fact.TDRR853_DOM_VERTICAL\nwhere cd_tipo_operacion='I'\nand cd_periodo='201706';",
				"txDesQuery": "suma de importe con filtros: periodo \"201706\", tipo operación \"I\"",
				"nbTabla": "TDRR853_DOM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DOMICILIACIONES",
			...
			"152": {
				"cdValidacion": 152,
				"txSqlQuery": "select sum(ct_domiciliacion) from zreg_fact.TDRR853_DOM_VERTICAL\nwhere cd_personalidad='M'\nand cd_periodo='201706';",
				"txDesQuery": "conteo de domiciliacion: periodo \"201706\", personalidad \"M\"",
				"nbTabla": "TDRR853_DOM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DOMICILIACIONES",
			...
			"153": {
				"cdValidacion": 153,
				"txSqlQuery": "select sum(ct_domiciliacion) from zreg_fact.TDRR853_DOM_VERTICAL\nwhere cd_personalidad='F'\nand cd_periodo='201706';",
				"txDesQuery": "conteo de domiciliacion: periodo \"201706\", personalidad \"F\"",
				"nbTabla": "TDRR853_DOM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DOMICILIACIONES",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.492Z",
				"fhModificacion": "2017-09-12T19:29:58.492Z",
				"resultado": {
					"txResultado": "37",
					"fhEjecucion": "09/8/2017"
				}
			...
			"154": {
				"cdValidacion": 154,
				"txSqlQuery": "select sum(ct_domiciliacion) from zreg_fact.TDRR853_DOM_VERTICAL\nwhere cd_tipo_operacion='I'\nand cd_periodo='201706';",
				"txDesQuery": "conteo de domiciliacion: periodo \"201706\", tipo operación \"I\"",
				"nbTabla": "TDRR853_DOM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DOMICILIACIONES",
			...
			"155": {
				"cdValidacion": 155,
				"txSqlQuery": "select sum(ct_domiciliacion) from zreg_fact.TDRR853_DOM_VERTICAL\nwhere cd_nivel_riesgo='1'\nand cd_periodo='201706';",
				"txDesQuery": "conteo de domiciliacion: periodo \"201706\", nivel de riesgo \"1\"",
				"nbTabla": "TDRR853_DOM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DOMICILIACIONES",
			...
			"156": {
				"cdValidacion": 156,
				"txSqlQuery": "select sum(ct_domiciliacion) from zreg_fact.TDRR853_DOM_VERTICAL\nwhere cd_nivel_riesgo='2'\nand cd_periodo='201706';",
				"txDesQuery": "conteo de domiciliacion: periodo \"201706\", nivel de riesgo \"2\"",
				"nbTabla": "TDRR853_DOM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DOMICILIACIONES",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.493Z",
				"fhModificacion": "2017-09-12T19:29:58.493Z",
				"resultado": {
					"txResultado": "43",
					"fhEjecucion": "09/8/2017"
				}
			...
			"157": {
				"cdValidacion": 157,
				"txSqlQuery": "select sum(ct_domiciliacion) from zreg_fact.TDRR853_DOM_VERTICAL\nwhere cd_nivel_riesgo='3'\nand cd_periodo='201706';\n",
				"txDesQuery": "conteo de domiciliacion: periodo \"201706\", nivel de riesgo \"3\"",
				"nbTabla": "TDRR853_DOM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DOMICILIACIONES",
			...
			"158": {
				"cdValidacion": 158,
				"txSqlQuery": "select sum(ct_domiciliacion) from zreg_fact.TDRR853_DOM_VERTICAL\nwhere cd_nivel_riesgo='4'\nand cd_periodo='201706';",
				"txDesQuery": "conteo de domiciliacion: periodo \"201706\", nivel de riesgo \"4\"",
				"nbTabla": "TDRR853_DOM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DOMICILIACIONES",
			...
			"159": {
				"cdValidacion": 159,
				"txSqlQuery": "select sum(im_domiciliacion) from zreg_fact.TDRR853_DOM_VERTICAL\nwhere cd_nivel_riesgo='1'\nand cd_periodo='201706';",
				"txDesQuery": "suma de importe con filtros: periodo \"201706\", nivel de riesgo tipo \"1\"",
				"nbTabla": "TDRR853_DOM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DOMICILIACIONES",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.494Z",
				"fhModificacion": "2017-09-12T19:29:58.494Z",
				"resultado": {
					"txResultado": "0",
					"fhEjecucion": "09/8/2017"
				}
			...
			"160": {
				"cdValidacion": 160,
				"txSqlQuery": "select sum(im_domiciliacion) from zreg_fact.TDRR853_DOM_VERTICAL\nwhere cd_nivel_riesgo='2'\nand cd_periodo='201706';",
				"txDesQuery": "suma de importe con filtros: periodo \"201706\", nivel de riesgo tipo \"2\"",
				"nbTabla": "TDRR853_DOM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DOMICILIACIONES",
			...
			"161": {
				"cdValidacion": 161,
				"txSqlQuery": "select sum(im_domiciliacion) from zreg_fact.TDRR853_DOM_VERTICAL\nwhere cd_nivel_riesgo='3'\nand cd_periodo='201706';",
				"txDesQuery": "suma de importe con filtros: periodo \"201706\", nivel de riesgo tipo \"3\"",
				"nbTabla": "TDRR853_DOM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DOMICILIACIONES",
			...
			"162": {
				"cdValidacion": 162,
				"txSqlQuery": "select sum(im_domiciliacion) from zreg_fact.TDRR853_DOM_VERTICAL\nwhere cd_nivel_riesgo='4'\nand cd_periodo='201706';",
				"txDesQuery": "suma de importe con filtros: periodo \"201706\", nivel de riesgo tipo \"4\"",
				"nbTabla": "TDRR853_DOM_VERTICAL",
				"nbEsquema": "fact",
				"cdSeccion": "TARJETAS",
				"cdConcepto": "DOMICILIACIONES",
				...
				"cdWorkflow": "empty",
				"nbUsuario": "SISPAGOS",
				"fhAlta": "2017-09-12T19:29:58.495Z",
				"fhModificacion": "2017-09-12T19:29:58.495Z",
				"resultado": {
					"txResultado": "4476384.46",
					"fhEjecucion": "09/8/2017"
				}
	...
	"secciones": {
		"CUENTAS DE NIVEL 4": {
			"rfp": 37,
			"CUENTAS A LA VISTA ASOCIADAS A NÓMINA": 10,
			"CUENTAS A LA VISTA NIVEL 4 EN M.N.": 38
		},
		"TARJETAS": {
			"rfp": 513,
			"DISTRIBUCIÓN DE CAJEROS": 143,
			"DISTRIBUCIÓN TPVS": 160,
			"MEDIOS DE PAGO": 160,
			"OPERACIONES EN CAJEROS AUTOMÁTICOS": 50
		},
		"SISTEMAS Y MEDIOS PARA TRANSFERENCIAS UTILIZADOS": {
			"rfp": 12,
			"BANCA ELECTRÓNICA": 29,
			"DOMICILIACIONES": 6,
			"TRANSFERENCIAS SWIFT": 2
		},
	...
	"relacionTablas": {
		"TDRR332_DOMICILIA": {
			...
			"dependencias": ["TDRR275_CAPTACION", "TDRR247_CLIENTE"]
		},
		"TDRR333_OPER_ATM": {
			"cdValidacion": 164,
			"nbEsquema": "ODS",
			...
			"dependencias": ["TDRR348_MP_EMITIDA"]
		},
		"TDRR348_MP_EMITIDA": {
			"cdValidacion": 165,
			"nbEsquema": "ODS",
		...
		"TDRR364_USU_AST": {
			...
			"txComentarios": "Carga de información STG de Usuarios",
			"dependencias": []
		},
		"TDRR365_FUN_AST": {
			"cdValidacion": 175,
		...
		"TDRR851_TPV_VERTICAL": {
			...
			"nbEsquema": "FACT",
			"nbTabla": "TDRR851_TPV_VERTICAL",
			"txComentarios": "CONTENDRÁ LOS ACUMULADOS DE TERMINALES PUNTO DE VENTA",
			"dependencias": []
		},
		"TDRR852_ATM_VERTICAL": {
			...
			"nbEsquema": "FACT",
			"nbTabla": "TDRR852_ATM_VERTICAL",
			"txComentarios": "CONTENDRÁ LOS ACUMULADS DE CAJEROS AUTOMÁTICOS",
			"dependencias": []
		},
		"TDRR853_DOM_VERTICAL": {
			...
			"nbEsquema": "FACT",
			"nbTabla": "TDRR853_DOM_VERTICAL",
			"txComentarios": "CONTENDRÁ LOS ACUMULADS DE DOMICILIACIONES",
			"dependencias": []
		},
		"TDRR855_MP_EMITIDA": {
			"cdValidacion": 181,
			...
			"txComentarios": "CONTENDRÁ LOS INDICADORES CORRESPONDIENTES A TARJETAS EMITIDAS",
			"dependencias": []
		},
		"TDRR856_MP_UTILIZADA": {
			...
			"txComentarios": "CONTENDRÁ LOS INDICADORES CORRESPONDIENTES A TARJETAS UTILIZADAS",
			"dependencias": []
		},
		"TDRR857_OPERA_TJTA": {
			"cdValidacion": 183,
			...
			"txComentarios": "CONTENDRÁ LOS INDICADORES CORRESPONDIENTES A LAS OPERACIONES REALIZADAS CON TARJETAS",
			"dependencias": []
		},
		"TDRR858_MP_COMERCIO": {
			"cdValidacion": 184,
			...
			"txComentarios": "CONTENDRÁ LOS INDICADORES CORRESPONDIENTES A COMERCIOS",
			"dependencias": []
		},
		"TDRR859_CU_REL_TJTA": {
			"cdValidacion": 185,
			...
			"txComentarios": "CONTENDRÁ LOS INDICADORES CORRESPONDIENTES A CUENTAS RELACIONADAS A TARJETAS UTILIZADAS EN EL TRIMESTRE",
			"dependencias": []
		},
		...
		"TDRR861_MP_CLIENTE": {
			...
			"txComentarios": "CONTENDRÁ LOS INDICADORES CORRESPONDIENTES A CLIENTES Y PAGO DE CLIENTES",
			"dependencias": []
		},
		"TDRR862_PAGO_TJTA": {
			"cdValidacion": 188,
			...
			"txComentarios": "CONTENDRÁ LOS INDICADORES CORRESPONDIENTES PAGO DE TARJETAS DE CRÉDITO DE CLIENTES EN OTROS BANCOS",
			"dependencias": []
		},
		"TDRR863_LOG_AST_USU": {
			"cdValidacion": 189,
